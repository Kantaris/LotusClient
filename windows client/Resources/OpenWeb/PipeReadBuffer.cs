...
namespace OpenWeb
{
	internal class PipeReadBuffer : System.IO.MemoryStream
	{
			...
			if ((ulong)num > (ulong)((long)capacity))
			{
				...
				else
				{
					if (num > 1073741823u)
					{
						...
						if (num2 >= 2147483647u)
						{
							throw new System.Exception("Sorry, the .NET Framework (and OpenWeb) cannot handle streams larger than 2 Gigabytes.");
						}
